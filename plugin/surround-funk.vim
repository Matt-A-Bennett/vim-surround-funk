...
nnoremap <silent> <Plug>YankSurroundingFunction :<C-U>call <SID>yank_surrounding_small_func()<CR>
nnoremap <silent> <Plug>YankSurroundingFUNCTION :<C-U>call <SID>yank_surrounding_big_func()<CR>
